...
function ProductList({ onHomeClick }) {
    ...
    const {items,totalItemsInCart} = useSelector(state => state.cart);
    ...
    return (
        <div>
            <div className="navbar">
                <div className="tag" onClick={(e) => handleHomeClick(e)}>
                ...
                <div className='plants_nav' onClick={(e) => handlePlantsClick(e)}>Plants</div>
                <div >
                    <div> 
                        <div  onClick={(e) => handleCartClick(e)}>
                            <div className='cart' >
                        ...
                        <div key={category.category}>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant) => {
                                    const inCart = items.some(item => item.name === plant.name);
                                    return (<div key={plant.name} className="product-card">
                                        <h3 className='product-title'>{plant.name}</h3>
                                        <img src={plant.image} alt={plant.name} className='product-image' />
                                        <p>{plant.description}</p>
                                        <p className='product-price'>{plant.cost}</p>
                                        <button disabled={inCart} onClick={()=>handleAddToCart(plant)} className={`product-button`}>
